 ...
 * @see https://v0.dev/t/fJn66bnuGQ2
 */
...
export default function Dashboard() {
  return (
    (<div
      className="grid min-h-screen bg-gray-100/40 lg:grid-cols-[280px_1fr] dark:bg-gray-800/40">
      <div
        className="hidden border-r border-gray-200 bg-white lg:block dark:border-gray-800 dark:bg-gray-950">
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div
            className="flex h-[60px] items-center border-b border-gray-100 px-6 dark:border-gray-950">
          ...
          <div className="w-full flex-1">
            <form>
              <div className="relative">
                ...
                <Input
                  className="w-full bg-gray-100/50 appearance-none shadow-none pl-8 md:w-2/3 lg:w-1/3 dark:bg-gray-800/50 dark:placeholder-gray-400/50"
                  placeholder="Search"
                  type="search" />
              </div>
            </form>
