  ...
  return (
    <div className="bg-yellow-500 flex justify-center m-[12px]  w-[100%] h-[60dvh] overflow-hidden  relative">
      ...
      /> */}
        ...
        className={`bg-red-500  object-contain translate-x-[0px] opacity-100 scale-100   transition-all ease-in-out delay-300 duration-1000  ${transitionstart==0?"translate-x-0 opacity-100 scale-100":"translate-x-[100%] opacity-0 scale-0"}`}
        ...
        //   className={`  object-contain  opacity-100 scale-100  transition-all ease-in-out delay-300 duration-1000 `}
          className={`bg-red-500  object-contain translate-x-[0px] opacity-100 scale-100   transition-all ease-in-out delay-300 duration-1000  ${transitionstart==1?"translate-x-0 opacity-100 scale-100":"translate-x-[100%] opacity-0 scale-0"}`}
        />
        ...
        //   className={`bg-black object-contain  opacity-100 scale-100  transition-all ease-in-out delay-300 duration-1000 `}
          className={`bg-red-500  object-contain translate-x-[0px] opacity-100 scale-100   transition-all ease-in-out delay-300 duration-1000  ${transitionstart==2?"translate-x-0 opacity-100 scale-100":"translate-x-[100%] opacity-0 scale-0"}`}
        />
