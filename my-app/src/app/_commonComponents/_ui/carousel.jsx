  ...
  return (
    <div className="bg-yellow-500 flex justify-center  w-[50%] h-[60dvh] relative">
      ...
      <Image
        src={src[2]}
        // fill
        className={`bg-red-500 w-[100%]  object-contain translate-x-[0px] opacity-100 scale-100   transition-all ease-in-out delay-300 duration-1000  ${transitionstart==2?"translate-x-0 opacity-100 scale-100":"translate-x-[100%] opacity-0 scale-0"}`}
      /> */}
